...
import { BookOpen, ArrowRight, Calendar, Hash, FileText } from "lucide-react";
      ...
      <section className="max-w-5xl mx-auto px-6 -mt-12 relative z-20">
        <div className="bg-white rounded-t-3xl shadow-2xl border border-slate-200 overflow-hidden">
          ...
          {current.articles.length > 0 ? (
            ...
            /* EMPTY STATE: Call for Papers */
            <div className="p-16 text-center">
              <div className="w-20 h-20 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-6 text-slate-300">
                <FileText size={32} />
              </div>
              <h3 className="font-serif text-2xl text-obsidian-900 mb-4">Submissions Open</h3>
              <p className="text-slate-500 max-w-lg mx-auto mb-8 leading-relaxed">
                This issue is currently in production. We are accepting manuscripts for peer review.
              </p>
              <Link href="/journal/guidelines" className="inline-flex items-center gap-2 px-8 py-3 bg-gold-500 text-obsidian-900 font-bold text-xs uppercase tracking-widest rounded hover:bg-obsidian-900 hover:text-white transition-all">
                Submit Manuscript
              </Link>
            </div>
          )}
